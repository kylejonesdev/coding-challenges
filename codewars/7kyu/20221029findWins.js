...
// Given a list of objects such as the above, return the number of times a country has won

function countWins(winnerList, country) {
  let res = winnerList.reduce((acc,item) => {
    return item.country === country ? acc + 1 : acc
  },0);
  return res;
}